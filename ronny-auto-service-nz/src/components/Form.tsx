const Form = () => {
  return (
    ...
    <div className=" max-w-xl border rounded-lg p-8">
      <form>
        ...
        <div className="flex mt-24">
          ...
          <div className="relative ml-12 z-0 w-1/4 mb-6 group">
            <input
              type="text"
              name="floating_first_name"
              id="floating_first_name"
          ...
          <div className="relative z-0 w-1/4 mb-6 ml-12 group">
            <input
              type="text"
              name="floating_first_name"
              id="floating_first_name"
        ...
        <button
          type="submit"
          className="w-36 mt-12 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Submit
        </button>
      </form>
